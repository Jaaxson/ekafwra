...
@Client.on_message(command(["playlist", "playlist@J_X_S5bot"]) & other_filters)
...
@Client.on_message(command(["delmyplaylist", "delmyplaylist@J_X_S5bot"]) & other_filters)
...
@Client.on_message(command(["delchatplaylist", "delchatplaylist@J_X_S5bot"]) & other_filters)
